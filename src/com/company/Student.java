...
public class Student implements Comparable<Student>{
    ...
    public static final AvgComparator AVG_COMPARATOR = new AvgComparator();
    public static final GroupComparator GROUP_COMPARATOR = new GroupComparator();

    public Student(String fio, int avgPoint, int groupNum, int age) {
        this.fio = fio;
        this.avgPoint = avgPoint; // средний балл
